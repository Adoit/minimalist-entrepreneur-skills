...
metadata:
  source: the-minimalist-entrepreneur
...
**Charge something. Always.** There is a massive difference between free and $1. Behavioral economists call it the "zero price effect" — people will line up for free items but the line disappears when you charge even 1 cent. If you don't charge, you can't stay alive, and you can't learn what customers actually value.
...
- Example: A multi-screen streaming feature costs the provider almost nothing but customers pay a premium
...
5. **Free trials are table stakes.** Customers now expect free trials — they open six tabs and compare immediately. Offer trials, but always with a clear path to paid.
